...
# CUDA_VISIBLE_DEVICES=$gpu_id python train.py policy="sac" seed=$seed wandb_project=$wandb_project task=$task eval_randomization=true use_wandb=$use_wandb asymmetric_critic=true
# CUDA_VISIBLE_DEVICES=$gpu_id python train.py policy="sac" seed=$seed wandb_project=$wandb_project task=$task eval_randomization=true use_wandb=$use_wandb asymmetric_critic=true
